                ...
                <div className="Page">
                    ...
                    <div className="TitleMenuContainer">
                        ...
                        */}
                        ...
                        <button className="LinkContainer" name="btn_editor" href="/simulation_editor" id="Cell Selection" onClick={()=>{window.location="/simulation_editor"}}name="btn_home_cell_selection" text="Cells">View Cells</button>
